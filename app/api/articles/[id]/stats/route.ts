...
export async function POST(
  ...
  try {
    ...
    const res = await fetch(`https://newsfile-backend.fly.dev/articles/${id}/stats`, {
      method: 'POST',
    });
    ...
    const mockData = mockStats[id] || {
      ...
      chart_data: [],
      key_facts: ['Please ensure your FastAPI backend is running at https://newsfile-backend.fly.dev'],
    };
